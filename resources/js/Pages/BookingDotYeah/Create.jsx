...
export default function Create({ rooms, flash }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log(typeof (data.room_type_id));
        console.log(data.room_type_id); // ตรวจสอบข้อมูลก่อนส่ง
        ...
        <>
            ...
            <div className="min-h-screen bg-gray-150 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-md w-full space-y-8">
                    <div>
                        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Create New Room</h2>
                    </div>
